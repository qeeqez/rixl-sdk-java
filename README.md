...
- Build date: 2026-03-20T18:57:54.849542+01:00[Africa/Lagos]
...
```xml
<dependency>
  <groupId>io.rixl</groupId>
  <artifactId>rixl-api</artifactId>
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'rixl-api' jar has been published to maven central.
    mavenLocal()       // Needed if the 'rixl-api' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "io.rixl:rixl-api:2.0.0"
  }
```
