...
import com.qeeqez.rixl.sdk.models.Post;
import java.util.HashMap;
import java.util.Map;
import java.util.Objects;
@jakarta.annotation.Generated("com.microsoft.kiota")
public class PaginatedResponsePost implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<Post> data;
    /**
     * Pagination data for the request.
     */
    private Pagination pagination;
    /**
     * Instantiates a new {@link PaginatedResponsePost} and sets the default values.
     */
    public PaginatedResponsePost() {
    ...
    public static PaginatedResponsePost createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public java.util.List<Post> getData() {
        return this.data;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("data", (n) -> { this.setData(n.getCollectionOfObjectValues(Post::createFromDiscriminatorValue)); });
     ...
     */
    public void setData(@jakarta.annotation.Nullable final java.util.List<Post> value) {
        this.data = value;
    }
    /**
