package com.qeeqez.rixl.sdk.models.pagination;
...
public class PaginatedResponseVideo implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<Video> data;
    /**
     * Pagination data for the request.
     */
    private Pagination pagination;
    /**
     * Instantiates a new {@link PaginatedResponseVideo} and sets the default values.
     */
    public PaginatedResponseVideo() {
    ...
    public static PaginatedResponseVideo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PaginatedResponseVideo();
    }
    /**
    ...
    public java.util.List<Video> getData() {
        return this.data;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("data", (n) -> { this.setData(n.getCollectionOfObjectValues(Video::createFromDiscriminatorValue)); });
     ...
     */
    public void setData(@jakarta.annotation.Nullable final java.util.List<Video> value) {
        this.data = value;
    }
    /**
