package com.qeeqez.rixl.sdk.videos.upload.init;
...
import com.qeeqez.rixl.sdk.models.github_com_qeeqez_api_internal_videos_handler_upload.InitResponse;
import com.qeeqez.rixl.sdk.models.VideoUploadInitRequest;
...
public class InitRequestBuilder extends BaseRequestBuilder {
    ...
    public InitRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/videos/upload/init", pathParameters);
    }
    /**
     * Instantiates a new {@link InitRequestBuilder} and sets the default values.
    ...
    public InitRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/videos/upload/init", rawUrl);
    }
    /**
    ...
    public InitResponse post(@jakarta.annotation.Nonnull final VideoUploadInitRequest body) {
     ...
     */
    @jakarta.annotation.Nullable
    public InitResponse post(@jakarta.annotation.Nonnull final VideoUploadInitRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, InitResponse::createFromDiscriminatorValue);
    }
    /**
     * Initialize a video upload and get presigned URLs for video and poster using API key authentication
     * @param body The request body
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final VideoUploadInitRequest body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final VideoUploadInitRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
