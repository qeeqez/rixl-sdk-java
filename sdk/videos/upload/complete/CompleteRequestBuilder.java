package com.qeeqez.rixl.sdk.videos.upload.complete;
...
import com.qeeqez.rixl.sdk.models.github_com_qeeqez_api_internal_videos_handler_upload.CompleteRequest;
...
public class CompleteRequestBuilder extends BaseRequestBuilder {
    ...
    public CompleteRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/videos/upload/complete", pathParameters);
    }
    /**
     * Instantiates a new {@link CompleteRequestBuilder} and sets the default values.
    ...
    public CompleteRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/videos/upload/complete", rawUrl);
    }
    /**
    ...
    public Video post(@jakarta.annotation.Nonnull final CompleteRequest body) {
     ...
     */
    @jakarta.annotation.Nullable
    public Video post(@jakarta.annotation.Nonnull final CompleteRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
