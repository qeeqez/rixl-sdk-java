package com.qeeqez.rixl.sdk.images.upload.init;
...
import com.qeeqez.rixl.sdk.models.internal_images_handler.InitResponse;
import com.qeeqez.rixl.sdk.models.internal_images_handler.UploadInitRequest;
...
public class InitRequestBuilder extends BaseRequestBuilder {
    ...
    public InitRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/images/upload/init", pathParameters);
    }
    /**
     * Instantiates a new {@link InitRequestBuilder} and sets the default values.
    ...
    public InitRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/images/upload/init", rawUrl);
    }
    /**
    ...
    public InitResponse post(@jakarta.annotation.Nonnull final UploadInitRequest body) {
     ...
     */
    @jakarta.annotation.Nullable
    public InitResponse post(@jakarta.annotation.Nonnull final UploadInitRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UploadInitRequest body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final UploadInitRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
